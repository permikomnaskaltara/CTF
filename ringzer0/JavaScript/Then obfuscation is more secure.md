Again, look at the script in page source. Now it's obfuscated.
<pre>
...
It's just weird, isn't it?. Use http://jsbeautifier.org/ to deobfuscate code.<br>
Now we have this:
<pre>
...
So the password is '02l1' + 'alk3'.<br>
GL